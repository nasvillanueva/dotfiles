...
"if filereadable(expand("~/.local/share/nvim/plugged/vim-noctu/colors/noctu.vim"))
"   colorscheme noctu
"endif
set background=dark
colo bleh
...
let $CLASSPATH .= '.:' . $HOME . '/.local/share/nvim/plugged/vim-javacomplete2/libs/javavi/target/classess'
