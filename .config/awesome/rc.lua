...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "Print", function() os.execute("$HOME/.bin/screenshot") end),
    ...
    awful.key({ modkey,           }, "d", function () awful.spawn(program_launcher) end,
              {description = "open a program launcher", group = "launcher"}),
