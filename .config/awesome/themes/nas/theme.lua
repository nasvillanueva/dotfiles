...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/nas"
...
theme.notification_bg = xrdb.color0
...
theme.fs = lain.widget.fs({
    ...
    notification_preset = { fg = theme.fg_focus, bg = theme.bg_normal, font = "lucy tewi 8" },
    settings = function()
...
local net = lain.widget.net({
    settings = function()
        widget:set_markup(markup.font(theme.font,
                          markup(xrdb.color2, " " .. net_now.received)
                          .. " " ..
                          markup(xrdb.color4, " " .. net_now.sent .. " ")))
    end
})

-- Separators
local spr     = wibox.widget.textbox(' ')
local arrl_dl = separators.arrow_left(xrdb.color8, "alpha")
local arrl_ld = separators.arrow_left("alpha", xrdb.color8)
...
--    gears.wallpaper.maximized(wallpaper, s, true)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            spr,
            arrl_ld,
            wibox.container.background(mpdicon, xrdb.color8),
            wibox.container.background(theme.mpd.widget, "#31313131"),
            arrl_dl,
            volicon,
            theme.volume.widget,
            --arrl_ld,
            ...
            --temp.widget,
            arrl_ld,
            wibox.container.background(fsicon, xrdb.color8),
            wibox.container.background(theme.fs.widget, xrdb.color8),
            arrl_dl,
            baticon,
            bat.widget,
            arrl_ld,
            wibox.container.background(neticon, xrdb.color8),
            wibox.container.background(net.widget, xrdb.color8),
            arrl_dl,
            clock,
            spr,
            arrl_ld,
            wibox.container.background(s.mylayoutbox, xrdb.color8),
        },
    }
end
